...
- (void)viewDidLoad {
    ...
    [self.navigationBar setTitleTextAttributes:[NSDictionary dictionaryWithObjectsAndKeys:[UIColor whiteColor], NSForegroundColorAttributeName, IOS7_Font(16), NSFontAttributeName, nil]];
    
    self.navigationBar.barTintColor = navigationBarColor;
//    self.navigationBar.barTintColor = UIColorFromRGB(0x3caafa);
